...
class GameState:
    ...
    def __set_resource(self, resource_type, amount, player_id=0):
        ...
        self.player_resources[player_id][resource_key] = held_resource + amount
    ...
    def project_future_bits(self, turns_in_future=1, player_id=0, current_bits=None):
        ...
        held by the player corresponding to player_id or starting from current_bits instead if it is provided. 
        '''
        bits = self.get_resource(self.BITS, player_id) if not current_bits else current_bits
