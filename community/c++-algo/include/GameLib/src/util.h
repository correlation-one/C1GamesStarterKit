/*
Description: Handles basic utility functions like communicating with the engine.
...
namespace terminal {
    ...
    /// All functions are static and should not be const.
    ...
    public:
        ...
        /// @param obj An object to print. This is often a string.
        ...
        /// @param warningLevel The level at which to throw this type of warning.
